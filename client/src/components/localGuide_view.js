...
6        let start = { address: startPoint, gps_coordinates: startPointGps }
        ...
        if(endId== null){
            console.log('EndId= null! Problems')
            return
        }
        
        console.log('Previous results: startId= ' + startId + ' endId= ' + endId)
        ...
        newHike = {
            ...
            description: description, gpx_track: title, local_guide: props.currentUser.email, hike_condition: 'open'
            //gpx_track: map --> request entity too large
        }

        console.log('Just before CreateNewHike call in localGuide ')
        console.log(newHike)
