...
function HutForm(props) {
    ...
    const [hutUrl, setHutUrl] = useState('')
    ...
    const changeEmail = (val) => { setEmail(val) }
    const changePhone = (val) => { setPhone(val) }
    const changeBeds = (val) => { setBeds(val) }
    const changeHutUrl = (val) => { setHutUrl(val) }
    ...
    return (<>
        ...
        <Form id='hutForm' onSubmit={submitHutForm} style={{ fontSize: 15, fontWeight: 'bold' }}>
            ...
            <Form.Group>
                <Row>
                    ...
                    <Col>
                        ...
                        <InputGroup className="mb-3">
                            <Form.Control value={altitude} onChange={(ev) => changeAltitude(ev.target.value)} placeholder="670" />
                            <InputGroup.Text id="basic-addon2">m</InputGroup.Text>
                        </InputGroup>
                    </Col>
                </Row>
            ...
            <Form.Group>
                <Row>
                    <Col>
                        ...
                        <Form.Control value={email} onChange={(ev) => changeEmail(ev.target.value)} />
                    </Col>
                    <Col>
                        <Form.Label>Phone Number</Form.Label>
                        <Form.Control value={phone} onChange={(ev) => changePhone(ev.target.value)} />
                    </Col>
                    <Col>
                        <Form.Label>Number of Beds</Form.Label>
                        <Form.Control value={beds} onChange={(ev) => changeBeds(ev.target.value)} />
                    </Col>
                </Row>
            </Form.Group>
            <Form.Group>
            ...
            <Form.Group>
                <Form.Label>Hut website</Form.Label>
                <Form.Control value={hutUrl} onChange={(ev) => changeHutUrl(ev.target.value)} />
            </Form.Group>

            <Button className='mt-y' type='submit' style={{ background: 'red' }}>Save</Button>
            <Button className='ms-2 my-2' style={{ background: 'red' }} onClick={reset}>Cancel</Button>
        </Form>
